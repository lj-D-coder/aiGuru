...
export const turboStreamChat = async (socket, param) => {
  ...
  if (subject === "Maths" || subject === "Physics" || subject === "Chemistry") {
    var mathsFormat = "If calculation is there, provide simple solution do not over complicate things, structured with new line tag properly and return compatible format for flutter_tex based on latex";
  }
