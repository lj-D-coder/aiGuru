...
export const turboStreamChat = async (socket, param) => {
  ...
  if (subject === "Maths" || subject === "Physics" || subject === "Chemistry") {
    var mathsFormat = "If calculation is there, provide step by step simple solution make it short and understandable to a student, return all mathematical equation wrap by $ symbol. example $a+b=c$";
  }
